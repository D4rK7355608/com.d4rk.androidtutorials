package com.d4rk.androidtutorials.ui.android.buttons.switch.tabs
...
class SwitchTabCodeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val inputStream = resources.openRawResource(R.raw.text_toggle_kotlin)
        val  text = inputStream.readBytes().toString(Charsets.UTF_8)
        inputStream.close()
        binding.textViewCode.text = text
        binding.textViewWarning.text = getString(R.string.same_code_switches)
        return binding.root
    }
