            ...
            drawerItems.forEach { item ->
                NavigationRailItem(selected = false , onClick = {
                    when (item.title) {
                        ...
                        R.string.updates -> IntentsHelper.openUrl(
                        ...
                        R.string.share -> IntentsHelper.shareApp(
                            context = mainScreenState.context , shareMessageFormat = R.string.summary_share_message
                        )
                    }
