package com.d4rk.androidtutorials.ui.android.clocks.chronometer.tabs
...
class ChronometerTabLayoutFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val textViewInputStream = resources.openRawResource(R.raw.text_chronometer_layout_xml)
        val extView = textViewInputStream.readBytes().toString(Charsets.UTF_8)
        textViewInputStream.close()
        binding.textView.text = extView
        return binding.root
    }
